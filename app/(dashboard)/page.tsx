              ...
              <>
                ...
                <div className="grid gap-4">
                  {bookmarks.map((bookmark) => (
                    <Card
                      key={bookmark.id}
                      className={`bg-zinc-900/50 border-white/10 backdrop-blur-sm overflow-hidden group hover:border-zinc-700 transition-colors ${
                        isProcessing(bookmark) ? 'animate-pulse' : ''
                      }`}
                    >
